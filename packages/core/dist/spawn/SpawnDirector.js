import { RUN_DURATION_MS, BOSS_SPAWN_MS } from '@solanasurvivors/shared';
import { SPAWN_TABLE } from '../balance/spawnTable';
export class SpawnDirector {
    constructor() {
        this.lastSpawnTime = 0;
        this.bossSpawned = false;
    }
    getBracket(elapsedMs) {
...
//# sourceMappingURL=SpawnDirector.js.map